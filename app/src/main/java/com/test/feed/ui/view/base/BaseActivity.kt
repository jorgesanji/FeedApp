...
import com.test.feed.ui.utils.IOAppPermission
...
abstract class BaseActivity<F : MVPFragment<*, *>> : AppCompatActivity() {
    ...
    var customLayout:Int = R.layout.activity_lay
    ...
    protected fun initFragment() {
        ...
        if (currentFragment != null) {
            ...
            transaction.add(com.test.feed.R.id.contentFrame, currentFragment)
            transaction.commit()
        }
    }
